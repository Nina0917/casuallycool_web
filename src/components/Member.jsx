...
function Member() {
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            <div>
            <h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">PRESIDENT</h2>
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 ">
              ...
              {members.map((member, index) => (
                ...
                <div
                  key={index}
                  className="flex bg-gradient-to-r from-orange-50 items-strech overflow-auto shadow-xl max-h-52 rounded-lg dark:bg-gray-800 dark:border-gray-700"
                >
                    <div class=" bg-gradient-to-r from-orange-50  sm:flex ">
                        ...
                        <div class="p-5">
                        <h3 class="italic text-xl font-normal text-gray-800 dark:text-white">{member.name} </h3>
                            <span class="italic text-gray-500 dark:text-gray-400">  {member.position} </span>
                            <br/>
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div><h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">SOCIAL MEDIA</h2>
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div><h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">EVENTS</h2>
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div><h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">FILM</h2>
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div><h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">DANCE</h2>
  ...
  class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div><h2 class="italic mb-4 text-xl tracking-wider font-normaltext-gray-900 dark:text-white">INTERN</h2>
